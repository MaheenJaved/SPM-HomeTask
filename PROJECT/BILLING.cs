    ...
    public partial class BILLING : Form
    {
        ...
        private void BILLING_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable Dt = SQL.select("select isnull(max(cast(BILLING_ID as int)),0)+1 From BILLING", con);
                //Sda.Fill(Dt);
        ...
        public void SEARCHBYNAME(string s)
        {
            ...
            //sda.Fill(dt);
            dataGridView1.DataSource = SQL.select(Query,con);
            con.Close();
        }
